'use strict';
describe('Controller: PostViewController', function () {

  // load the controller's module
  beforeEach(module('jwwebApp'));
  beforeEach(module('MainController'));

  // var $rootScope,$scope,$sce,$q,$http,$route,$routeParams,$location,AuthFactory,AWSFactory,CategoryFactory,ServerUrl,trace;
